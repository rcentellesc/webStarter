            ...
            link: function($scope, elem, attr) {
                ...
                $timeout(function() {
                    ...
                    function eventHandler(e) {
                        ...
                        // check if the target is an exception in attributes
                        if($scope.$eval(attr.exception)!=null)
                        {
                            if (e.target.id==attr.exception)
                            {
                                return;
                            }
                        }
                        //Check if our element or his childs is the target
