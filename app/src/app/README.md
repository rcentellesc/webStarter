...
|  |- init.js: Usado para inicializar todos los módulos al inicio.
|  |- directives/: Aquí vienen todas las directivas creadas (tendrán sus estilos en less/ sus html en templates/ y su código en raíz xxx.js
|  |- logic/: Aquí tendremos toda la lógica del proyecto, una carpeta por cada objeto de negocio. En esta carpeta encontramos el fichero xxx.js que es el raíz
